...
#define TEST_ICO_16_16_16_DATA_SZ \
   (sizeof( struct BITMAP_DATA_HEADER ) + \
   ((16 * 16) / 2) + ((16 * 16) / 2) + /* Bitmap Data */ \
   (4 * 16)) /* Palette Entries */

#define TEST_ICO_16_16_16_SZ \
   (TEST_ICO_16_16_16_DATA_SZ + \
   sizeof( struct ICO_DIR_HEADER ) + \
   sizeof( struct ICO_DIR_ENTRY_HEADER ))

static const uint8_t gc_test_ico_16_16_16[TEST_ICO_16_16_16_SZ] = {
   ...
   TEST_ICO_16_16_16_DATA_SZ, 0x00, 0x00, 0x00,
   sizeof( struct ICO_DIR_HEADER ) +
      sizeof( struct ICO_DIR_ENTRY_HEADER ), 0x00, 0x00, 0x00,
   ...
   0x04, 0x00,                /* BPP */
   0x00, 0x00, 0x00, 0x00,    /* Compression */
   0x80, 0x00, 0x00, 0x00,    /* Bitmap Size */
   0x48, 0x00, 0x00, 0x00,    /* HRes */
   0x48, 0x00, 0x00, 0x00,    /* VRes */
   0x10, 0x00, 0x00, 0x00,    /* Colors */
   0x10, 0x00, 0x00, 0x00,    /* Important Colors */
