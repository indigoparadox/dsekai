...
#define graphics_sprite_at( spr, x, y ) \
   graphics_blit_at( \
      (const GRAPHICS_BITMAP*)spr, NULL, 0, 0, x, y, SPRITE_W, SPRITE_H - 1, \
      sizeof( SPRITE_TYPE ) )
#define graphics_tile_at( spr, x, y ) \
   graphics_blit_at( \
      (const GRAPHICS_BITMAP*)spr, NULL, 0, 0, x, y, TILE_W, TILE_H, \
      sizeof( TILE_TYPE ) )
#define graphics_pattern_at( spr, x, y ) \
   graphics_blit_at( \
      (const GRAPHICS_BITMAP*)spr, NULL, 0, 0, x, y, PATTERN_W, PATTERN_H, \
      sizeof( PATTERN_TYPE ) )
...
void graphics_blit_at( const GRAPHICS_BITMAP*, const GRAPHICS_MASK*,
